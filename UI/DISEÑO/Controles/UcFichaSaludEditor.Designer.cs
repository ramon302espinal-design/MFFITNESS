...
{
    partial class UcFichaSaludEditor
    {
        ...
        {
            lblContactoEmergencia = new Label();
            lblEmergenciaNombre = new Label();
            txtEmergenciaNombre = new TextBox();
            lblEmergenciaParentesco = new Label();
            txtEmergenciaParentesco = new TextBox();
            lblEmergenciaTelefono = new Label();
            txtEmergenciaTelefono = new TextBox();
            lblEmergenciaTelefonoAlt = new Label();
            ...
            lblAntiguedadCirugia = new Label();
            ...
            lblFechaIngresoFicha = new Label();
            dtpFechaIngresoFicha = new DateTimePicker();
            ...
            // 
            AutoScroll = true;
            AutoScrollMinSize = new Size(1380, 1480);
            BackColor = Color.White;
            Controls.Add(lblContactoEmergencia);
            Controls.Add(lblEmergenciaNombre);
            Controls.Add(txtEmergenciaNombre);
            Controls.Add(lblEmergenciaParentesco);
            Controls.Add(txtEmergenciaParentesco);
            Controls.Add(lblEmergenciaTelefono);
            Controls.Add(txtEmergenciaTelefono);
            Controls.Add(lblEmergenciaTelefonoAlt);
            Controls.Add(txtEmergenciaTelefonoAlt);
            Controls.Add(lblEnfermedades);
            Controls.Add(chkDiabetes);
            Controls.Add(chkHipertension);
            Controls.Add(chkAsma);
            Controls.Add(chkProblemasCardiacos);
            Controls.Add(chkColesterolAlto);
            Controls.Add(chkArtritis);
            Controls.Add(chkHernia);
            Controls.Add(chkEpilepsia);
            Controls.Add(chkEmbarazo);
            Controls.Add(chkNingunaEnfermedad);
            Controls.Add(lblEnfermedadOtra);
            Controls.Add(txtEnfermedadOtra);
            Controls.Add(lblLesiones);
            Controls.Add(chkLesionHombro);
            Controls.Add(chkLesionRodilla);
            Controls.Add(chkLesionEspalda);
            ...
            Controls.Add(panelMedicamentos);
            Controls.Add(lblListaMedicamentos);
            Controls.Add(txtListaMedicamentos);
            Controls.Add(lblAlergias);
            Controls.Add(panelAlergias);
            Controls.Add(lblAlergiasDescripcion);
            Controls.Add(txtAlergiasDescripcion);
            Controls.Add(lblCirugias);
            Controls.Add(panelCirugias);
            Controls.Add(lblCirugiasDescripcion);
            Controls.Add(txtCirugiasDescripcion);
            Controls.Add(lblCirugiasFecha);
            Controls.Add(dtpCirugiasFecha);
            Controls.Add(lblAntiguedadCirugia);
            Controls.Add(lblObjetivoFitness);
            Controls.Add(lblObjetivoHint);
            Controls.Add(chkObjPerderGrasa);
            Controls.Add(chkObjGanarMasa);
            Controls.Add(chkObjTonificar);
            Controls.Add(chkObjMejorarCondicion);
            Controls.Add(chkObjRehabilitacion);
            Controls.Add(chkObjSalud);
            Controls.Add(chkObjCompetencia);
            Controls.Add(chkObjOtro);
            Controls.Add(txtObjOtroDescripcion);
            Controls.Add(lblExperiencia);
            Controls.Add(panelExperiencia);
            Controls.Add(lblHorarioPreferido);
            Controls.Add(panelHorario);
            Controls.Add(lblFechaIngresoFicha);
            Controls.Add(dtpFechaIngresoFicha);
            Font = new Font("Segoe UI", 10F);
            Name = "UcFichaSaludEditor";
            Size = new Size(1420, 980);
            // 
            // lblContactoEmergencia
            // 
            lblContactoEmergencia.AutoSize = true;
            lblContactoEmergencia.Font = new Font("Segoe UI", 13F, FontStyle.Bold);
            lblContactoEmergencia.ForeColor = Color.Red;
            lblContactoEmergencia.Location = new Point(20, 16);
            lblContactoEmergencia.Name = "lblContactoEmergencia";
            lblContactoEmergencia.Size = new Size(306, 30);
            lblContactoEmergencia.TabIndex = 0;
            lblContactoEmergencia.Text = "CONTACTO DE EMERGENCIA";
            // 
            // lblEmergenciaNombre
            // 
            lblEmergenciaNombre.AutoSize = true;
            lblEmergenciaNombre.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblEmergenciaNombre.Location = new Point(20, 58);
            lblEmergenciaNombre.Name = "lblEmergenciaNombre";
            lblEmergenciaNombre.Size = new Size(83, 23);
            lblEmergenciaNombre.TabIndex = 1;
            lblEmergenciaNombre.Text = "NOMBRE";
            // 
            // txtEmergenciaNombre
            // 
            txtEmergenciaNombre.Font = new Font("Segoe UI", 11F);
            txtEmergenciaNombre.Location = new Point(130, 54);
            txtEmergenciaNombre.Name = "txtEmergenciaNombre";
            txtEmergenciaNombre.Size = new Size(280, 32);
            txtEmergenciaNombre.TabIndex = 2;
            // 
            // lblEmergenciaParentesco
            // 
            lblEmergenciaParentesco.AutoSize = true;
            lblEmergenciaParentesco.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblEmergenciaParentesco.Location = new Point(430, 58);
            lblEmergenciaParentesco.Name = "lblEmergenciaParentesco";
            lblEmergenciaParentesco.Size = new Size(117, 23);
            lblEmergenciaParentesco.TabIndex = 3;
            lblEmergenciaParentesco.Text = "PARENTESCO";
            // 
            // txtEmergenciaParentesco
            // 
            txtEmergenciaParentesco.Font = new Font("Segoe UI", 11F);
            txtEmergenciaParentesco.Location = new Point(560, 54);
            txtEmergenciaParentesco.Name = "txtEmergenciaParentesco";
            txtEmergenciaParentesco.Size = new Size(280, 32);
            txtEmergenciaParentesco.TabIndex = 4;
            // 
            // lblEmergenciaTelefono
            // 
            lblEmergenciaTelefono.AutoSize = true;
            lblEmergenciaTelefono.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblEmergenciaTelefono.Location = new Point(20, 102);
            lblEmergenciaTelefono.Name = "lblEmergenciaTelefono";
            lblEmergenciaTelefono.Size = new Size(95, 23);
            lblEmergenciaTelefono.TabIndex = 5;
            lblEmergenciaTelefono.Text = "TELEFONO";
            // 
            // txtEmergenciaTelefono
            // 
            txtEmergenciaTelefono.Font = new Font("Segoe UI", 11F);
            txtEmergenciaTelefono.Location = new Point(130, 98);
            txtEmergenciaTelefono.Name = "txtEmergenciaTelefono";
            txtEmergenciaTelefono.Size = new Size(280, 32);
            txtEmergenciaTelefono.TabIndex = 6;
            // 
            // lblEmergenciaTelefonoAlt
            // 
            lblEmergenciaTelefonoAlt.AutoSize = true;
            lblEmergenciaTelefonoAlt.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblEmergenciaTelefonoAlt.Location = new Point(430, 102);
            lblEmergenciaTelefonoAlt.Name = "lblEmergenciaTelefonoAlt";
            lblEmergenciaTelefonoAlt.Size = new Size(161, 23);
            lblEmergenciaTelefonoAlt.TabIndex = 7;
            lblEmergenciaTelefonoAlt.Text = "TEL. ALTERNATIVO";
            // 
            // txtEmergenciaTelefonoAlt
            // 
            txtEmergenciaTelefonoAlt.Font = new Font("Segoe UI", 11F);
            txtEmergenciaTelefonoAlt.Location = new Point(600, 98);
            txtEmergenciaTelefonoAlt.Name = "txtEmergenciaTelefonoAlt";
            txtEmergenciaTelefonoAlt.Size = new Size(240, 32);
            txtEmergenciaTelefonoAlt.TabIndex = 8;
            // 
            // lblEnfermedades
            // 
            lblEnfermedades.AutoSize = true;
            lblEnfermedades.Font = new Font("Segoe UI", 13F, FontStyle.Bold);
            lblEnfermedades.ForeColor = Color.Red;
            lblEnfermedades.Location = new Point(20, 154);
            lblEnfermedades.Name = "lblEnfermedades";
            lblEnfermedades.Size = new Size(183, 30);
            lblEnfermedades.TabIndex = 9;
            ...
            chkDiabetes.Location = new Point(20, 196);
            chkDiabetes.Name = "chkDiabetes";
            chkDiabetes.Size = new Size(98, 27);
            chkDiabetes.TabIndex = 10;
            ...
            chkAsma.Location = new Point(620, 196);
            ...
            chkArtritis.Location = new Point(620, 232);
            chkArtritis.Name = "chkArtritis";
            chkArtritis.Size = new Size(82, 27);
            chkArtritis.TabIndex = 15;
            ...
            chkHernia.Location = new Point(20, 268);
            chkHernia.Name = "chkHernia";
            chkHernia.Size = new Size(82, 27);
            chkHernia.TabIndex = 16;
            ...
            chkEpilepsia.Location = new Point(320, 268);
            chkEpilepsia.Name = "chkEpilepsia";
            chkEpilepsia.Size = new Size(98, 27);
            chkEpilepsia.TabIndex = 17;
            ...
            chkEmbarazo.Location = new Point(620, 268);
            chkEmbarazo.Name = "chkEmbarazo";
            chkEmbarazo.Size = new Size(108, 27);
            chkEmbarazo.TabIndex = 18;
            ...
            lblLesiones.Location = new Point(20, 356);
            lblLesiones.Name = "lblLesiones";
            lblLesiones.Size = new Size(113, 30);
            lblLesiones.TabIndex = 22;
            ...
            lblLesionDescripcion.Location = new Point(20, 476);
            ...
            txtListaMedicamentos.Location = new Point(20, 636);
            txtListaMedicamentos.Name = "txtListaMedicamentos";
            txtListaMedicamentos.PlaceholderText = "Ej: Losartán 50mg, Metformina...";
            txtListaMedicamentos.Size = new Size(760, 32);
            txtListaMedicamentos.TabIndex = 34;
            // 
            // lblAlergias
            // 
            ...
            lblAlergias.Location = new Point(20, 688);
            lblAlergias.Name = "lblAlergias";
            lblAlergias.Size = new Size(115, 30);
            lblAlergias.TabIndex = 35;
            ...
            txtAlergiasDescripcion.Location = new Point(20, 798);
            txtAlergiasDescripcion.Name = "txtAlergiasDescripcion";
            txtAlergiasDescripcion.PlaceholderText = "Describa las alergias...";
            txtAlergiasDescripcion.Size = new Size(760, 32);
            txtAlergiasDescripcion.TabIndex = 38;
            // 
            // lblCirugias
            // 
            ...
            lblCirugias.Location = new Point(20, 850);
            lblCirugias.Name = "lblCirugias";
            lblCirugias.Size = new Size(114, 30);
            lblCirugias.TabIndex = 39;
            ...
            txtCirugiasDescripcion.Location = new Point(140, 928);
            txtCirugiasDescripcion.Name = "txtCirugiasDescripcion";
            txtCirugiasDescripcion.PlaceholderText = "Describa la cirugía...";
            txtCirugiasDescripcion.Size = new Size(640, 32);
            txtCirugiasDescripcion.TabIndex = 42;
            // 
            // lblCirugiasFecha
            // 
            ...
            dtpCirugiasFecha.Location = new Point(140, 972);
            dtpCirugiasFecha.MinDate = new DateTime(1950, 1, 1, 0, 0, 0, 0);
            dtpCirugiasFecha.Name = "dtpCirugiasFecha";
            dtpCirugiasFecha.Size = new Size(240, 32);
            dtpCirugiasFecha.TabIndex = 44;
            // 
            // lblAntiguedadCirugia
            // 
            lblAntiguedadCirugia.AutoSize = true;
            lblAntiguedadCirugia.Enabled = false;
            lblAntiguedadCirugia.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblAntiguedadCirugia.ForeColor = Color.FromArgb(0, 122, 204);
            lblAntiguedadCirugia.Location = new Point(400, 976);
            lblAntiguedadCirugia.Name = "lblAntiguedadCirugia";
            lblAntiguedadCirugia.Size = new Size(0, 23);
            lblAntiguedadCirugia.TabIndex = 45;
            // 
            // lblObjetivoFitness
            // 
            ...
            chkObjSalud.Location = new Point(620, 1106);
            chkObjSalud.Name = "chkObjSalud";
            chkObjSalud.Size = new Size(74, 27);
            chkObjSalud.TabIndex = 53;
            ...
            chkObjOtro.Location = new Point(320, 1142);
            chkObjOtro.Name = "chkObjOtro";
            chkObjOtro.Size = new Size(67, 27);
            chkObjOtro.TabIndex = 55;
            ...
            txtObjOtroDescripcion.Location = new Point(400, 1138);
            txtObjOtroDescripcion.Name = "txtObjOtroDescripcion";
            txtObjOtroDescripcion.PlaceholderText = "Especifique otro objetivo...";
            txtObjOtroDescripcion.Size = new Size(380, 32);
            txtObjOtroDescripcion.TabIndex = 56;
            // 
            // lblExperiencia
            // 
            ...
            panelExperiencia.Location = new Point(20, 1232);
            panelExperiencia.Name = "panelExperiencia";
            panelExperiencia.Size = new Size(760, 70);
            panelExperiencia.TabIndex = 58;
            // 
            // rbExpNunca
            // 
            ...
            rbExp1Ano.Location = new Point(400, 4);
            ...
            panelHorario.Location = new Point(20, 1356);
            panelHorario.Name = "panelHorario";
            panelHorario.Size = new Size(760, 70);
            panelHorario.TabIndex = 60;
            // 
            // rbHorManana
            // 
            ...
            txtHorarioVariadoDetalle.Location = new Point(100, 32);
            txtHorarioVariadoDetalle.Name = "txtHorarioVariadoDetalle";
            txtHorarioVariadoDetalle.PlaceholderText = "Detalle del horario...";
            txtHorarioVariadoDetalle.Size = new Size(400, 32);
            txtHorarioVariadoDetalle.TabIndex = 4;
            // 
            // lblFechaIngresoFicha
            // 
            lblFechaIngresoFicha.AutoSize = true;
            lblFechaIngresoFicha.Font = new Font("Segoe UI", 13F, FontStyle.Bold);
            lblFechaIngresoFicha.ForeColor = Color.Red;
            lblFechaIngresoFicha.Location = new Point(20, 1446);
            lblFechaIngresoFicha.Name = "lblFechaIngresoFicha";
            lblFechaIngresoFicha.Size = new Size(214, 30);
            lblFechaIngresoFicha.TabIndex = 61;
            lblFechaIngresoFicha.Text = "FECHA DE INGRESO";
            // 
            // dtpFechaIngresoFicha
            // 
            dtpFechaIngresoFicha.Font = new Font("Segoe UI", 11F);
            dtpFechaIngresoFicha.Location = new Point(250, 1446);
            dtpFechaIngresoFicha.Name = "dtpFechaIngresoFicha";
            dtpFechaIngresoFicha.Size = new Size(240, 32);
            dtpFechaIngresoFicha.TabIndex = 62;
        ...
        private Label lblEmergenciaNombre;
        private TextBox txtEmergenciaNombre;
        private Label lblEmergenciaParentesco;
        private TextBox txtEmergenciaParentesco;
        private Label lblEmergenciaTelefono;
        private TextBox txtEmergenciaTelefono;
        private Label lblEmergenciaTelefonoAlt;
        ...
        private Label lblAntiguedadCirugia;
        ...
        private Label lblFechaIngresoFicha;
        private DateTimePicker dtpFechaIngresoFicha;
    }
}
